...
delete(Path p) and deleteIfExists(Path p) from Files to delete
a file , a directory , and a symbolic 
delete() method throws an exception if the deletion fails.

deleteIfExists() method does not throw a NoSuchFileException if the 
...
public class DeleteFile{
	public static void main(String... args) throws Exception{
		Path p=Paths.get("E:\\anand\\Not.class");
		try{
			//Files.delete(p)

...
If teh specified source file is a symbolic link, the target of the symbolic link is copied  not the symbolic link.
...
Path source=Paths.get("E:\\Anand\\Bind\\Anand.txt");
Path target=Paths.get("E:\\Anand\\Bind\\Anand1.txt");
try{
